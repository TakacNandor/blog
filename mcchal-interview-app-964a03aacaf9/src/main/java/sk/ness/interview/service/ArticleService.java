...
public interface ArticleService {
	...
	/**
	 * Returns all available {@link Article}s containing selected {@link String}
	 * .
	 */
	List<Article> search(String searchedWord);
	...
	List<Comment> findByIdWithComments(final Integer articleId);
}
