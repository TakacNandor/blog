This application is a simple blog API.
 It offers capability to add Articles, list them by various criteria.
...
There are 2 runners
	- sk.ness.interview.ApplicationRunner which runs the whole applications including web server
	- sk.ness.interview.ArticleIngester which runs just the necessary parts of the system 

	
After starting the whole application using ApplicationRunner,
 web server is accessible on localhost:8080
...
PUT http://localhost:8080/articles/add - creates a new article.
